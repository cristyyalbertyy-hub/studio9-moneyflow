(function () {
  ...
  const messages = {
    pt: {
      ...
      "profit.pendingReimbursementsTitle": "Atencao",
      "profit.pendingReimbursementsMsg": "Reembolsos a efectuar.",
      ...
      "api.pendingReimbursements": "Existem reembolsos por efectuar.",
    ...
    en: {
      ...
      "profit.pendingReimbursementsTitle": "Attention",
      "profit.pendingReimbursementsMsg": "Reimbursements still to be made.",
      "profit.migrationNotice":
      ...
      "api.pendingReimbursements": "There are reimbursements still to be made.",
  ...
  const apiErrorMap = {
    ...
    "Existem reembolsos por efectuar.": "api.pendingReimbursements",
