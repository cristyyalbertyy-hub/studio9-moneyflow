...
function computeAccountBalancesByCurrency(incomes, expenses, documents) {
...
function computeAccountBalance(incomes, expenses, documents) {
  return computeAccountBalancesByCurrency(incomes, expenses, documents).EUR;
}
...
async function getBootstrapData() {
  ...
  return {
    ...
    summary: {
      ...
      accountBalances: computeAccountBalancesByCurrency(incomes, expenses, documents),
...
async function getAccountBalance(db, currency = DEFAULT_CURRENCY) {
  let [incomesRes, expensesRes, documentsRes] = await Promise.all([
  ...
  const balances = computeAccountBalancesByCurrency(incomes, expenses, documents);
